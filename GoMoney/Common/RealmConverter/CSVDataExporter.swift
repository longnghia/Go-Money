...
open class CSVDataExporter: DataExporter {
    ...
    func exportSchemas(toFolderAtPath outputFolderPath: String, schemas: [String]? = nil) throws {
        ...
        for objectSchema in realm.schema.objectSchema {
            ...
            print("objectSchema=\(objectSchema.className)")
    ...
    override open func export(toFolderAtPath outputFolderPath: String) throws {
        try exportSchemas(toFolderAtPath: outputFolderPath, schemas: nil)
    }
